    ...
    <html lang="en">
      <body className={plusJakartaSans.className}>
        <div className="flex h-screen">
          <aside className="bg-[#F7F8FA] border-r border-r-[#EBECF2] h-full">
            <ul className="h-full flex flex-col gap-1 py-5">
              ...
              <li className="px-1.5">
                <button className="bg-white flex flex-col gap-2 p-2 rounded-full mx-auto">
                  <span className="bg-[#34CAA5] toggle-item">
                    <Image
                      src={"/brightness.svg"}
                      height={18}
                      width={18}
