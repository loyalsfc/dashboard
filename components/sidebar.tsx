...
function Sidebar() {
    ...
    return (
        <aside className="bg-[#F7F8FA] border-r border-r-[#EBECF2] h-full dark:bg-[#171717] dark:border-r-[#737373] transition-all">
            <ul className="h-full flex flex-col gap-1 py-5">
                <li>
                ...
                <li className="px-1.5">
                    <button onClick={handleSwitch} className="bg-white dark:bg-[#262626] flex flex-col gap-2 p-2 rounded-full mx-auto">
                        <span className="bg-[#34CAA5] dark:bg-[#262626] transition-all toggle-item">
                            <Image
                                src={"/brightness.svg"}
                                height={18}
                                width={18}
                        ...
                        <span className="toggle-item dark:bg-[#34CAA5] transition-all">
                            <Image
                                src={"/moon.svg"}
                                height={24}
                                width={24}
